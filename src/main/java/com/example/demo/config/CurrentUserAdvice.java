...
public class CurrentUserAdvice {
    ...
    public String currentUserName(HttpSession session) {
        Object value = session.getAttribute("AUTH_NAME");
    ...
    public boolean isAdmin(HttpSession session) {
        return RolUsuario.fromValue((String) session.getAttribute("AUTH_ROLE")) == RolUsuario.ADMIN;
    }
    ...
    public boolean isCliente(HttpSession session) {
        return RolUsuario.fromValue((String) session.getAttribute("AUTH_ROLE")) == RolUsuario.CLIENTE;
    }
